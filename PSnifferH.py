...
# ctypes class for reading packet headers in C (alternative method of decoding IP header)
# from ctypes import *
# import struct
...
#unpacks the header to binary and assigns fields into a data structure
import ipaddress
import struct
